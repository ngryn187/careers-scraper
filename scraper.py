...
async def health():
    ...
    return {"status": "ok", "version": "8.10.0", "openai_key_set": bool(openai.api_key), "redis_connected": redis_ok, "db_connected": db_ok}
...
@app.get("/badge/{domain}.svg", media_type="image/svg+xml")
async def hiring_badge(domain: str):
    ...
    svg = f"""<svg xmlns="http://www.w3.org/2000/svg" width="120" height="20" role="img" aria-label="StackSight: {label}">
    ...
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="110">
        ...
        <text x="925" y="140" transform="scale(.1)" textLength="450">{label}</text>
    </g>
</svg>"""
