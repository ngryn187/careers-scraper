...
<nav class="sidebar">
  ...
  <div style="padding:24px 20px 0;margin-top:auto">
    <a href="/" style="font-size:13px;color:#6b7280">Ã¢ÂÂ Back to Home</a>
  </div>
</nav>
<main class="main">
  <h1>API Documentation</h1>
  <p>Turn any domain into a complete company profile Ã¢ÂÂ hiring signals, tech stack, and enrichment data in one REST API call.</p>
  ...
  <div class="plan-grid">
    ...
    <div class="plan-card">
      ...
      <div class="plan-sub">per month ÃÂ· 60/min</div>
    </div>
    <div class="plan-card pro">
      <div class="plan-name">Pro</div>
      <div class="plan-limit">5,000</div>
      <div class="plan-sub">per month ÃÂ· 300/min</div>
    </div>
    <div class="plan-card">
      <div class="plan-name">Business</div>
      <div class="plan-limit">50,000</div>
      <div class="plan-sub">per month ÃÂ· 1,000/min</div>
    </div>
  </div>
  ...
  <p>Enrich up to 50 domains in a single request. Runs concurrently Ã¢ÂÂ same speed as one. Each domain counts as 1 request against your monthly quota.</p>
  <table>
  ...
  <table>
    ...
    <tr><td>source</td><td>string</td><td>"cache" or "live" Ã¢ÂÂ whether data was served from cache or freshly scraped</td></tr>
  ...
  <table>
    ...
    <tr><td>429</td><td>Rate limit exceeded Ã¢ÂÂ retry after 60s</td></tr>
...
async def demo(domain: str, request: Request):
    ...
    return await demo_page(domain, request)
@app.get("/scrape")
