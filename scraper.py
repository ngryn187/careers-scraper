...
.hero-demo-input-row{{display:flex;gap:0;background:#111;border:1.5px solid #2a2a2a;border-radius:14px;padding:6px 6px 6px 18px;align-items:center;transition:border-color .2s}}
.hero-demo-input-row:focus-within{{border-color:#7c3aed}}
.hero-demo-input-row input{{flex:1;padding:10px 0;background:transparent;border:none;color:#fff;font-size:15px;outline:none}}
.hero-demo-input-row input::placeholder{{color:#374151}}
...
.hero-demo-input-row button:hover{{opacity:.85}}
.hero-demo-input-row button:disabled{{opacity:.5;cursor:not-allowed}}
